...
public class PublicMailBoxActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_public_mail_box);

        initRecyclerView();

        SearchView searchView = (SearchView)findViewById(R.id.search_view_public_plan);
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextChange(String newText) {
                ...
                Toast.makeText(PublicMailBoxActivity.this, "text changed", Toast.LENGTH_SHORT).show();
                initRecyclerView();
                return false;
            }
        });
    ...
    private void initRecyclerView(){
        ...
        mailbox.clear();
        //获取RecyclerView
        mRecyclerView = findViewById(R.id.recycler_view_public_plan);
        //设置线性布局管理器
        mRecyclerView.setLayoutManager(new LinearLayoutManager(this));

        List<MailboxInfo> mailbox_w = mailService.findPublicMainList();
        ...
        adapter.setOnItemClickListener(new ChildPlanCardAdapter.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                Utils.actionStart(PublicMailBoxActivity.this, MailDetailActivity.class, String.valueOf(mailbox.get(0).getIdMail()), null);
            }
