...
import com.example.myapplication.LocationUtil.FixedSpeedScroller;
import com.example.myapplication.LocationUtil.LogUtil;
import com.example.myapplication.LocationUtil.ZoomOutPageTransformer;
import com.example.myapplication.custom.CustomViewPager;
import com.example.myapplication.custom.RadarViewGroup;
import com.example.myapplication.module.LocationInfo;

import java.lang.reflect.Field;

public class LocationActivity extends AppCompatActivity implements ViewPager.OnPageChangeListener, RadarViewGroup.IRadarClickListener {
    ...
    private String[] mNames = {"Amy", "Deemo", "Lucas", "ANGUISH", "Miracle", "Phineas", "HeiFengLei", "Han"};
    private int mPosition;
    private FixedSpeedScroller scroller;
    private SparseArray<LocationInfo> mDatas = new SparseArray<>();
    ...
    private void setViewPagerSpeed(int duration) {
        try {
            ...
            scroller = new FixedSpeedScroller(LocationActivity.this, new AccelerateInterpolator());
    ...
    class ViewpagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, final int position) {
            final LocationInfo info = mDatas.get(position);
            //设置一大堆演示用的数据，麻里麻烦~~
            View view = LayoutInflater.from(LocationActivity.this).inflate(R.layout.viewpager_layout, null);
            ...
            ivPortrait.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Toast.makeText(LocationActivity.this, "这是 " + info.getName() + " >.<", Toast.LENGTH_SHORT).show();
                }
            });
